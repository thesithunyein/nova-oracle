...
export function NovaLogo({ size = 32 }: { size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="nova-fur" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Ears */}
      <circle cx="10" cy="8" r="4.5" fill="url(#nova-fur)" />
      <circle cx="22" cy="8" r="4.5" fill="url(#nova-fur)" />
      {/* Head */}
      <ellipse cx="16" cy="16" rx="9.5" ry="9" fill="url(#nova-fur)" />
      {/* Eyes */}
